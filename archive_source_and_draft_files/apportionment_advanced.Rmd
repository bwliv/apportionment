...
##### **Please note this is the data journalists' version. Other journalists looking for a less technical explanation of our findings may access one here [here](https://bwliv.github.io/apportionment_journalists).**
...
If the same level of undercounting happened in 2020, which states might gain or lose a seat? 

Let's run that analysis by overlaying the 2010 undercount data with the 2018 American Community Survey state population estimates, and seeing which states could miss out on 
