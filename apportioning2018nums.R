...
states_org = read.csv('2018ACS.csv',header=F,stringsAsFactors = F)
...
states = read.csv('2018ACS.csv',header=F,stringsAsFactors = F)
...
write.csv(totals,file='seat_loss_gain_2018.csv')